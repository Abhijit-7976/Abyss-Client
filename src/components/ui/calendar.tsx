  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_dropdowns: "flex gap-3 -ml-3",
        ...classNames,
      }}
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="h-4 w-4" />,
        IconRight: ({ ...props }) => <ChevronRight className="h-4 w-4" />,
        // dropdowns for months and years
        Dropdown: props => {
          ...
          if (props.name === "months") {
            ...
            return (
              <Select
                onValueChange={newValue => {
                  ...
                  new Date(newDate.setMonth(parseInt(newValue)));
                  goToMonth(newDate);
                }}
            ...
            return (
              <Select
                onValueChange={newValue => {
                  const newDate = new Date(currentMonth);
                  new Date(newDate.setFullYear(parseInt(newValue)));
                  goToMonth(newDate);
                }}
                value={props.value?.toString()}>
